...
This project is indexed by GitNexus as **KirkForge** (27 symbols, 23 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
